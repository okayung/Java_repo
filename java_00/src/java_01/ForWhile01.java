...
//		
		...
		System.out.println("for 의 6의 배수 ");
		for (int i =1; i<=100; i++) {
			if(i % 6 == 0) {
				System.out.print(i + " ");
			}
		...
		int w =1;
		System.out.println("while 의 6의 배수 ");
		int whileTotal = 0;
		...
		System.out.println("(for) 1-60000까지의 정수 중 100의 배수는 몇개? " + cnt);
		System.out.println();
		...
		System.out.println("(for) 1-60000까지의 정수 중 100의 배수는 몇개? " + cCnt);
