...
//		ArrayList<String> solBook = forYouDAO.solutionBook();
//		
...
//		int randomIndex = (int)(Math.random() * solutionBook.size());
//		String.randomElement = solutionBook.get(randomIndex);
...
//		
	...
	public void fortuneBook() {
		...
		// 고민해결책의 답 가져오기
		String result = forYouDAO.selectBook("forturne");
		
//		ArrayList<String> forBook = forYouDAO.fortuneBook();
//		
